...
def train(model, criterion, train_loader, val_loader, optimizer, num_epochs,):
    ...
    for epoch in range(num_epochs):
      ...
      with torch.no_grad():
          ...
          if network_achieve:
              ...
              torch.save(model.state_dict(), './models/model_ok.ckpt')

              print('The best model is detected')


    # torch.save(model.state_dict(), 'model.pth')
    percent = 100. * correct / len(val_loader.dataset)
